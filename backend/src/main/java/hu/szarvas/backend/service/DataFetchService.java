...
import hu.szarvas.backend.integration.AreasResponse;
import hu.szarvas.backend.integration.CompetitionsResponse;
import hu.szarvas.backend.integration.MatchesResponse;
import hu.szarvas.backend.integration.TeamsResponse;
